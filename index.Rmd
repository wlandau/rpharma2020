...
Let's talk about workflow automation. In the life sciences, we develop ambitious computational workflows for Statistics and data science. There's a lot of Bayesian analysis, machine learning, etc. And we often struggle with efficiency and reproducibility.
